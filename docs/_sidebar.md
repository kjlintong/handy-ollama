* 目录
    ...
    * 第 1 章 Ollama 与本地 AI 生态
        * [1.1 Ollama 与本地 AI 生态](C1/1.%20Ollama%20与%20本地%20AI%20生态.md)
    * 第 2 章 安装与配置
        ...
        * [2.5 GPU/CPU 混合推理配置](C2/5.%20GPU-CPU%20混合推理配置.md)
    * 第 3 章 模型管理与自定义
        * [3.1 自定义导入模型](C3/1.%20自定义导入模型.md)
        * [3.2 自定义模型存储位置](C3/2.%20自定义模型存储位置.md)
        * [3.3 自定义在 GPU 中运行](C3/3.%20自定义在%20GPU%20中运行.md)
        * [3.4 GGUF 深度解析与量化选型](C3/4.%20GGUF%20深度解析与量化选型.md)
        * [3.5 Modelfile 高级编写](C3/5.%20Modelfile%20高级编写.md)
