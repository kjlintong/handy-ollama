...
> **版本基线**：Ollama 0.17.x（与 [10.1 RAG 原理](../C10/1.%20RAG%20原理与本地组件.md) 配套的实战章节）
...
You can also [see this page](https://python.langchain.com/docs/integrations/text_embedding/) for a full list of available embeddings models
