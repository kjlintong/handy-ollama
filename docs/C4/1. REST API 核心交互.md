...
> **版本基线**：Ollama 0.17.x
> **章节定位**：聚焦 REST API 的请求/响应结构，掌握与本地模型交互的核心模式。OpenAI 兼容接口与 Tool Calling 分别见 [2. OpenAI 兼容接口](./2.%20OpenAI%20兼容接口.md) 与 [3. Tool Calling API](./3.%20Tool%20Calling%20API.md)。
